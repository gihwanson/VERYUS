...
const NEWCOMER_LIST_STATE_KEY = 'veryus_newcomer_list_state_v1';

const NewcomerPostList: React.FC = () => {
  ...
  if (persistedStateRef.current === null) {
    try {
      const raw = sessionStorage.getItem(NEWCOMER_LIST_STATE_KEY);
...
export default NewcomerPostList; 