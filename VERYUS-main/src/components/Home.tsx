          ...
          >
            <div className="profile-info">
              ...
              <span className="profile-name">
                ...
                {user?.grade && (
                  <span className="profile-grade" style={{ fontSize: 28, marginLeft: 4 }}>
                    ({user.grade.match(/[\u{1F300}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}]/u)?.[0] || '🍒'})
                  </span>
                )}
              </span>
              <ChevronDown 
